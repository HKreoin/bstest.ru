    ...
    <div class="py-10">
        <div class="mx-auto max-w-3xl space-y-6 px-4 text-sm text-gray-700 sm:px-6 lg:px-8">
            ...
            <section class="space-y-2">
                ...
                <p>
                    Сайт использует cookie для работы сессии и защиты форм. Подробнее — на странице
            ...
            <section class="space-y-2">
                ...
                <p>Оператор вправе обновлять настоящую политику. Актуальная версия всегда доступна по адресу {{ url('/privacy') }}.</p>
            </section>
        </div>
    </div>
</x-app-layout>
